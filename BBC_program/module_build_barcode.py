...
def barcodes_plot (data_sorted, dic_name2, l_row_csv, nb_of_row, scale_or_not, graduation, genome_len) :
    ...
    for i in range(len(l_row_csv)) :
        ...
        for el in l_row_csv[i]:
            ...
            ax.axvspan((el[0][0]), (el[0][1]+1), alpha=1, facecolor= col , edgecolor = 'none' )
